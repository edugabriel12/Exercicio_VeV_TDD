package com.br.functionalTests;
import com.br.gerenciadordetarefas.domain.Tarefa;
import com.br.gerenciadordetarefas.service.GerenciadorTarefasService;
...
public class FunctionalTests {
    ...
    public void deveCriarTarefa(){
        //Criar uma tarefa
        Tarefa tarefa1 = new Tarefa("", "fazer alteracoes na tela", new Date(), Prioridade.ALTA );
        assertNotNull(tarefa1);

        Tarefa tarefa2 = new Tarefa("OS1", "", new Date(), Prioridade.ALTA );
    ...
    public void NaodeveExcluirTarefa(){
        ...
        GerenciadorTarefasService tarefaService = new GerenciadorTarefasService(tarefas);
        tarefaService.excluirTarefa(tarefa3);

        assertTrue(tarefaService.getListaDeTarefas().contains(tarefa1));
